...
public class MessageController {
    ...
    @PostMapping(value = "/api/v1/sensum/publish", consumes = MediaType.APPLICATION_XML_VALUE, produces = MediaType.APPLICATION_XML_VALUE, MediaType.APPLICATION_JSON_VALUE})
